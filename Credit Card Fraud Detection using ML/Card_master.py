...
#_+++++++++++++++++++++++++++++++++++++++++++++++++++++++
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=300, height=500, bd=5, font=('times', 15, ' bold '),bg="#40BFFF")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=30, y=150)
...
button1 = tk.Button(frame_alpr, text="Card Master", command=card_entry ,width=15, height=1, font=('times', 15, ' bold '),bg="Darkgoldenrod2",fg="blue")
button1.place(x=50, y=30)

button2 = tk.Button(frame_alpr, text="Merchant Master", command=Merchant_win, width=15, height=1, font=('times', 15, ' bold '),bg="Darkgoldenrod2",fg="blue")
button2.place(x=50, y=90)

button3 = tk.Button(frame_alpr, text="Face Capture", command=Face, width=15, height=1, font=('times', 15, ' bold '),bg="Darkgoldenrod2",fg="blue")
...
# button5 = tk.Button(frame_alpr, text="Decision Tree", command=CL_DST,width=15, height=1, font=('times', 15, ' bold '),bg="Darkgoldenrod2",fg="blue")
# button5.place(x=50, y=270)

# button6 = tk.Button(frame_alpr, text="Naive Bayes", command=CL_NB,width=15, height=1, font=('times', 15, ' bold '),bg="Darkgoldenrod2",fg="blue")
